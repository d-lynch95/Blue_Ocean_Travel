# **Blue Ocean Travel Deployment &amp; Local Development**

![amiresponsive mock-ups of Blue Ocean Travel](docs/readme_images/responsive.png)

<br/>

**[Link to the Deployed Site](https://blue-ocean-travel-feb523e57a47.herokuapp.com/)**

---
## **Deployment Steps**

Blue Ocean Travel is deployed on Heroku and uses AWS3 for staticfiles cloud storage.
...
```
This will automatically create the JSON file and will dump all the model instances of the app into the file. Blue Ocean Travel's **products app** has a MainCategory, Category, Subcategory, Brand and Product models.
```bash
...
```Procfile
web: gunicorn blue_ocean_travel.wsgi:application
```
...
* Add a name for your group, eg. manage-blue-ocean, then click *create policy* button
...
* We have to create a user for the group. Click *Users* from the left sidebar and then click the *add users* button and add a name for the user, eg. blue-ocean-staticfiles-user
...
* On the Blue Ocean Travel repository, click the *Fork* butoon on the top right side of the page.
* A forked version of Blue Ocean Travel will be available as one of your repositories on GitHub

---
## How to Clone the repository
* On the Blue Ocean Travel repository page, click the *<> Code* button (left of the green *GitPod* button)
